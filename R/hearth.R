...
#'   \item \code{Class}. factor. Ordinal target variable - severity of coronary artery disease (determined using angiograms) (1 = no disease; 2 = degree 1; 3 = degree 2; 4 = degree 3; 5 = degree 4)
#' }
#' \verb{ }\cr
...
#'
#' @format A data frame with 294 observations, ten covariates and one ordinal target variable
